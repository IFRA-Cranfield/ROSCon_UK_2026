...
- https://github.com/IFRA-Cranfield/ros2_SimRealRobotControl/blob/humble-gzfortress/instructions/RobotOperation.md (bottom lines) for better detail about the ROS 2 Gazebo environment object spawn process.
